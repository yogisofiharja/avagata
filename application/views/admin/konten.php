<!-- Main Content -->
	<section role="main">
		...
		<!-- Breadcumbs -->
		<ul id="breadcrumbs">
			<li><a href="http://envato.parallaq.com/" title="Back to Homepage">Back to Home</a></li>
		...
		<article class="full-block clearfix">
			...
			<section>
				...
				<div class="sidetabs">
					...
					<nav class="sidetab-switch">
						<ul>
							<li><a class="default-sidetab" href="#sidetab4">Sample Side Tab</a></li>
							<li><a href="#sidetab5">Some more tabs</a></li>
						</ul>
						<p>Aenean facilisis ligula eget orci adipiscing varius. Curabitur sem ligula, egestas vel bibendum sed, sodales eu nulla. Vestibulum luctus aliquam feugiat. Donec porta interdum placerat.</p>
					</nav>
					<!-- /Side Tab Navigation -->
