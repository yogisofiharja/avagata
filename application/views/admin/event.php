<!-- Article Header -->
		...
		<!-- /Article Header -->
<label>Update Eventmu atau Tambah Eventmu <a href="<?php echo base_url();?>admin/get/tambah_event">Di sini</a></label></br>
<br/><br/><br/>
<table class="datatable">
	...
	<tbody>
		...
		<tr class="gradeX">
			...
			<td><?php echo $row->jam_mulai_event;?></td>
			<td><?php echo $row->jam_akhir_event;?></td>
