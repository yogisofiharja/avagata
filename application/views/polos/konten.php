  <div class="body">
    <div class="bgg">     
      <div class="right">  
        ...
        <img src="images/img_1.jpg" alt="picture" width="145" height="145" class="floated" />
        <p><strong>It has survived not only five centuries, but also the leap into <br />
          electronic typesetting, remaining essentially unchanged. </strong></p>
        <p>It was popularised in the 1960s with the release of Letraset sheets <br />
